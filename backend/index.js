...
// Make sure to replace <port> with a port number of your choosing such as 8080 or 3001.
...
const fs = require("fs");
//Sets up our express application and returns a message back 
//to console once our application is running.
app.use(cors());
...
//The new json object is finally appended to a json list located in a file called 
//database.json to represent our todos list.
